Python Deep Dive Summaries
================

Various Jupyter notebooks and Python sources associated with my Udemy Python 3 Deep Dive course series. Each part contains a summary notebook.
