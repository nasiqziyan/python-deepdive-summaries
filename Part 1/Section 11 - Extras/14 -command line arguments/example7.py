...
# we don't need to write both '-f' and '--first' but its a good habit. 
# also, its common to use single dash for single letters and double dash for multiple letters e.g --first
...
# by default, the kw we give e.g. --first will be used as the property name for accessing that argument, 
# but we can rename it using the keyword: dest. Ideally we have short names for the keyword and more expressive
# names for dest
